...
<body>
  ...
  <div class="login-conatiner">
     ...
     <form action="adminloginfirst.php" method="post">
      <?php include('errorsregister.php'); ?>
    
      <img class="avatar" src="img/admin-login.jpg"><br><br>
      ...
      <div class="i">
       ...
       <div>
   		...
   		<input type="password" name="password" placeholder="Password" style="margin-right:20px;">
   		</div>
    </div>
